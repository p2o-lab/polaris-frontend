...
export class Icon {
    ...
    static getIcon(serviceStatus) {
        switch (serviceStatus) {
            ...
            case 'ABORTING':
            case 'ABORTED':
                return 'M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,' +
            ...
            case 'IDLE':
            case 'RESETTING':
                return'M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,' +
                  '8 0 0,1 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z';
            case 'RESTART':
                return 'M 12 5 V 1 L 7 6 l 5 5 V 7 c 3.31 0 6 2.69 6 6 s ' +
            ...
            case 'pinOff':
                return 'M16,12V4H17V2H7V4H8V12L6,14V16H11.2V22H12.' +
                  '8V16H18V14L16,12M8.8,14L10,12.8V4H14V12.8L15.2,14H8.8Z';
            case 'settings':
                return 'M12,15.5A3.5,3.5 0 0,1 8.5,12A3.5,3.5 0 0,1' +
            ...
            case 'unknown':
                return 'M 21.83 7.56 C 20.39 6.52 18.44 6 15.98 6 C ' +
